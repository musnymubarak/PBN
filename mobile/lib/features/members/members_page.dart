...
class _MembersPageState extends State<MembersPage> {
  ...
  void initState() {
    super.initState();
    // Use PostFrameCallback to initiate fetch if needed
  ...
  void _filterMembers(List<Member> members, String query) {
    setState(() {
      ...
      _filtered = members.where((m) => 
        ...
        m.industry.toLowerCase().contains(query.toLowerCase()) || 
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text('${members.length} Members', style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: AppColors.text)),
          ],
        ),
      ),
      body: Column(
                  ...
                  child: ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      ...
                      errorWidget: (context, url, error) => Container(
                        ...
                        child: Center(
                          child: Text(member.initials, style: const TextStyle(fontWeight: FontWeight.w800, color: Colors.white, fontSize: 16)),
                        ),
                      ),
                    ),
                  ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(member.company, maxLines: 1, overflow: TextOverflow.ellipsis,
